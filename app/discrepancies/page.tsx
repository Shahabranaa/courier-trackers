...
export default function DiscrepanciesPage() {
  ...
  const [summary, setSummary] = useState<Summary>({ total: 0, postex: 0, tranzo: 0, tcs: 0, leopards: 0, totalAmount: 0 });
  ...
  async function fetchDiscrepancies() {
    ...
    try {
      ...
      setSummary(data.summary || { total: 0, postex: 0, tranzo: 0, tcs: 0, leopards: 0, totalAmount: 0 });
    } catch (err) {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Leopards Returns</p>
            <p className="text-3xl font-bold text-teal-600 mt-1">{summary.leopards}</p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">TCS Returns</p>
            <p className="text-3xl font-bold text-red-600 mt-1">{summary.tcs}</p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
