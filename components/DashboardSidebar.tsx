...
import { LayoutDashboard, Truck, Package, Settings, LogOut, ChevronLeft, ChevronRight, PieChart, ChevronDown, Plus, Building2, ShoppingBag, TrendingUp, Bell, Zap, GitCompare, Receipt, Wallet, Shield, User } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="p-3 border-t border-gray-100 space-y-1">
                {isAdmin && (
                    <Link href="/admin" className="flex items-center gap-3 w-full p-2 hover:bg-gray-50 rounded-xl transition-colors group">
                        ...
                        {!collapsed && (
                            <div className="text-left overflow-hidden">
                                <p className="text-sm font-medium text-gray-900 group-hover:text-indigo-700">Admin Panel</p>
